...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { description: @monster.description, height: @monster.height, name: @monster.name, weight: @monster.weight } }, as: :json
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { description: @monster.description, height: @monster.height, name: @monster.name, weight: @monster.weight } }, as: :json
    assert_response 200
  end
